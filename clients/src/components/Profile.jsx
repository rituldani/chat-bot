  ...
  return (
    ...
    <div style={{ transition: showProfile ? "0.3s ease-in-out" : "" }} className={props.className}>
      <div className='absolute  w-[100%]'>
        <div className='bg-[#166e48] dark:bg-zinc-700 dark:border-b-2 dark:border-zinc-800 pt-12 pb-3'>
        ...
        <div className=' pt-5'>
          ...
          <div>
            <div className='py-5 px-4'>
              <p className='text-[10px] tracking-wide text-[#3b4a54] dark:text-[#E5E7EB] '>
